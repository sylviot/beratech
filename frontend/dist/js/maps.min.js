    ...
    value: function addGeometries(geojson) {
      ...
      try {
        ...
        features.forEach(function (feature) {
          var uuid = _this2._geoManager.addGeometry(feature, options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _utils_translations_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/translations.js */ "./assets/js/utils/translations.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _slicedToArray(r, e) { return _arrayWithHoles(r) || _iterableToArrayLimit(r, e) || _unsupportedIterableToArray(r, e) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
...
var BaseRenderer = /*#__PURE__*/function () {
  ...
  function BaseRenderer(beraMap, geometryType) {
    ...
    if (!(0,_utils_translations_js__WEBPACK_IMPORTED_MODULE_0__.isLanguageAvailable)(this.config.language)) {
      console.warn("Idioma '".concat(this.config.language, "' n\xE3o dispon\xEDvel. Usando 'pt-BR'."));
  ...
  return _createClass(BaseRenderer, [{
    ...
    value: function setLanguage(language) {
      if (!(0,_utils_translations_js__WEBPACK_IMPORTED_MODULE_0__.isLanguageAvailable)(language)) {
        console.warn("Idioma '".concat(language, "' n\xE3o dispon\xEDvel."));
        return false;
      }
    ...
    value: function _createPopupContent(feature) {
      var _this2 = this;
      var metadata = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var properties = feature.properties || {};
      var hasProperties = Object.keys(properties).length > 0;
      var html = '<div class="bera-popup">';

      // Adicionar título se existir
      if (properties.name) {
        html += "<h3 style=\"margin: 0 0 8px 0; font-weight: bold;\">".concat(this._escapeHtml(properties.name), "</h3>");
      }

      // Adicionar descrição se existir
      if (properties.description) {
        html += "<p style=\"margin: 0 0 8px 0; font-size: 0.9em;\">".concat(this._escapeHtml(properties.description), "</p>");
      }
      ...
      if (metadata && Object.keys(metadata).length > 0) {
        ...
        Object.entries(metadata).forEach(function (_ref) {
          var _ref2 = _slicedToArray(_ref, 2),
            key = _ref2[0],
            value = _ref2[1];
          if (value !== null && value !== undefined && key !== 'uuid' && key !== 'feature' && key !== 'style' && key !== 'latLng') {
            ...
            if (key === 'type' && (value === 'polygon' || value === 'polyline')) {
              displayValue = (0,_utils_translations_js__WEBPACK_IMPORTED_MODULE_0__.getTranslation)(_this2.config.language, "geometryTypes.".concat(value), value);
            }

            // Traduzir label e valor de isClosed
            var label = keyTranslationMap[key];
            if (!label) {
              ...
              label = (0,_utils_translations_js__WEBPACK_IMPORTED_MODULE_0__.getTranslation)(_this2.config.language, label, label);
            }

            // Traduzir valor boolean
            if (key === 'isClosed' && typeof value === 'boolean') {
              displayValue = value ? 'Sim' : 'Não';
              if (_this2.config.language === 'en-US') {
                displayValue = value ? 'Yes' : 'No';
              }
            }
            html += "<div style=\"margin: 4px 0; font-size: 0.85em;\"><strong>".concat(label, ":</strong> ").concat(displayValue, "</div>");
          }
        });
      }
      ...
      if (!hasProperties && (!metadata || Object.keys(metadata).length === 0)) {
        var noInfoText = (0,_utils_translations_js__WEBPACK_IMPORTED_MODULE_0__.getTranslation)(this.config.language, 'popupLabels.noInfo', 'Sem informações disponíveis');
        html += "<p style=\"margin: 0; font-size: 0.9em; color: #999; font-style: italic;\">".concat(noInfoText, "</p>");
      }
      html += '</div>';
      return html;
    }
  ...
  return _createClass(CircleRenderer, [{
    ...
    value: function _attachEventListeners(circle, uuid, feature) {
      ...
      circle.on('click', function (e) {
        ...
        var metadata = circle._beraMetadata || {};

        // Criar e abrir popup
        if (_this3.config.enablePopup) {
          var popupContent = _this3._createPopupContent(feature, metadata);
  ...
  return _createClass(DrawingRenderer, [{
    ...
    value: function _attachEventListeners(layer, uuid, feature) {
      ...
      layer.on('click', function (e) {
        var geometryData = _this3.beraMap._geoManager.getGeometryByUUID(uuid);
        var metadata = layer._beraMetadata || {};
  ...
  return _createClass(LineRenderer, [{
    ...
    value: function _attachEventListeners(polyline, uuid, feature) {
      ...
      polyline.on('click', function (e) {
        ...
        var metadata = polyline._beraMetadata || {};

        // Criar e abrir popup
        if (_this2.config.enablePopup) {
          var popupContent = _this2._createPopupContent(feature, metadata);
  ...
  return _createClass(PointRenderer, [{
    ...
    value: function _attachEventListeners(marker, uuid, feature) {
      ...
      marker.on('click', function (e) {
        var geometryData = _this2.beraMap._geoManager.getGeometryByUUID(uuid);
        var metadata = marker._beraMetadata || {};
  ...
  return _createClass(PolygonRenderer, [{
    ...
    value: function _attachEventListeners(polygon, uuid, feature) {
      ...
      polygon.on('click', function (e) {
        var geometryData = _this2.beraMap._geoManager.getGeometryByUUID(uuid);
        var metadata = polygon._beraMetadata || {};
...
/* harmony export */   isLanguageAvailable: () => (/* binding */ isLanguageAvailable)
/* harmony export */ });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function getTranslation(language, key) {
  ...
  var translations = TRANSLATIONS[language] || TRANSLATIONS['pt-BR'];
